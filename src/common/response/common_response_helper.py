...
def success_response(data: Any = None, message: str = "Success",code:int = 200, status: str = "success"):
    return ResponseModel(status="success",code=code, message=message, data=data)

def error_response(message: str = "Error",code:int = 200, data: Any = None,status: str = "success"):
